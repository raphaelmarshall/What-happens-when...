...
and the OS interrupts that occur when you start typing on your browser.
...
As you are typing "google.com" many blocks of code run in the background and the suggestions will be refined with each keypress.
